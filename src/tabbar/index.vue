...
// #endif
const activeColor = 'var(--tabbar-active-color)'
const inactiveColor = 'var(--tabbar-inactive-color)'
...
<template>
  <view v-if="customTabbarEnable" class="h-50px pb-safe">
    <view class="border-and-fixed bg-white" :style="{ zIndex: ZIndex.fixed }" @touchmove.stop.prevent>
