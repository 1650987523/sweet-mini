...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'http://localhost:8081/app'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'http://101.201.57.221/:8081/app'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'http://101.201.57.221/:8081/app'
